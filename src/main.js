 ...
 */
export function isPrime (m, primes) {
 ...
 */
export function sieve (n) {					// eslint-disable-line no-unused-vars
 ...
 */
export function factorize (n) {					// eslint-disable-line no-unused-vars
	n = parseInt(n, 10);
 ...
 */
export function condenseFactorList (factors) {
...
export function divisorHelper (factorsAsObject, primeFactors, i, numPrimeFactors, accumulator) {
